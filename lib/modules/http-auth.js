...
* ---------------------------------------------------------------- */
'use strict';
const mHttp   = require('@tradle/react-native-http');
const createHash = require('rn-create-hash');
...
OnvifHttpAuth.prototype.request = function(options, callback) {
	...
	let req = mHttp.request(options, (res) => {
...
OnvifHttpAuth.prototype._handleHttpDigest = function(http, res, callback) {
	...
	let req = mHttp.request(this.options, callback);
	req.end();
};
